...
app.post('/auth/login', async (req, res) =>{
    ...
    try{
        ...
        res.status(200).json({msg: 'Authentication completed', token, userId: user._id})
    }catch(err){
        console.log(error)
...
mongoose
    .connect(
        `mongodb+srv://${dbUser}:${dbPassword}@cluster0.gulwnoc.mongodb.net/?retryWrites=true&w=majority`
    )
    .then(()=>{
